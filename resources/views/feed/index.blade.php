...
@endif
@push('styles')
<link rel="stylesheet" href="{{ asset('css/community-help.css') }}?v=1">
<style>
...
<section class="help-feed-cta" aria-labelledby="help-feed-cta-title"><h2 id="help-feed-cta-title"><i class="fa-solid fa-hand-holding-heart me-1"></i> Precisa resolver algo perto de você?</h2><p>Envie uma necessidade local com cidade, bairro e urgência. A equipe analisa antes da publicação.</p><div class="help-feed-cta-actions"><a class="help-feed-cta-link" href="{{ auth()->check() ? route('community-help.create') : route('login') }}"><i class="fa-solid fa-plus"></i> Preciso agora</a><a class="help-feed-cta-link is-secondary" href="{{ route('community-help.index') }}"><i class="fa-solid fa-compass"></i> Ver pedidos locais</a></div></section>
