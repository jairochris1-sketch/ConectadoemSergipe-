...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Subcategorias por tipo de atuação
    |--------------------------------------------------------------------------
    |
    | O tipo de anunciante identifica quem presta o serviço. A subcategoria
    | identifica o serviço oferecido e, por isso, é filtrada pelo tipo escolhido.
    |
    */
    'service_categories_by_profile_kind' => [
        'professional' => [
            'Aluga Cadeiras e Mesas',
            'Cabeleireira',
            'Carroceiro',
        ...
        'cultural_artist' => [
            ...
            'Ateliê Artístico',
            'Ator / Atriz',
            'Cantor / Cantora e Banda',
            'Cordelista',
            'Dançarino / Dançarina e Coreógrafo',
            'Escritor / Escritora',
            'Fotógrafo Artístico',
        ...
        'hiring_company' => [
            ...
            'Vagas Comerciais e Vendas',
            'Vagas de Emprego',
            'Vagas Operacionais e Serviços Gerais',
            'Vagas em Saúde e Educação',
            'Vagas em Tecnologia e TI',
        ],
    ],
