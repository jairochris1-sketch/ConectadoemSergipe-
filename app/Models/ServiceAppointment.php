...
class ServiceAppointment extends Model
{
    ...
    protected $fillable = ['ad_id', 'service_procedure_id', 'service_staff_id', 'customer_user_id', 'service_client_subscription_id', 'customer_name', 'customer_phone', 'starts_at', 'ends_at', 'service_price', 'status', 'notes', 'attendance_mode'];
    ...
    public function getAttendanceModeLabelAttribute(): ?string { return ['presencial' => 'Presencial', 'online' => 'Online / teleconsulta'][$this->attendance_mode] ?? null; }
}
